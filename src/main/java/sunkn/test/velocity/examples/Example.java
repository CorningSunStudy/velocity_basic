package sunkn.test.velocity.examples;
...
public class Example {
	public Example(String templateFile) {
		try {
			...
			Velocity.init("src/main/java/sunkn/test/velocity/examples/velocity.properties");
	...
	public static void main(String[] args) {
		...
		String templateFile = "src/main/java/sunkn/test/velocity/examples/example.vm";
		new Example(templateFile);
	}
